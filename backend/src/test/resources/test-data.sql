...
-- ADMIN
-- mail/username: slavko@rentr.com
-- password: admin
INSERT INTO users(id, deleted, email, enabled, first_name, last_name, password, phone_number, role)
VALUES ('6447c259-812c-4d33-afae-484ab00a5628', false, 'slavko@rentr.com', true, 'Slavko', 'Stevi',  '$2a$12$aSdnp/ZQTnSDHWFuBZlybOIjhMWcY7GRNlZMHPYoQekbN3BaHM4AS', '', 'ADMIN');
INSERT into admins(id) VALUES ('6447c259-812c-4d33-afae-484ab00a5628');

-- UNVERIFIED_ADMIN
-- mail/username: damir@rentr.com
-- password: admin
INSERT INTO users(id, deleted, email, enabled, first_name, last_name, password, phone_number, role)
VALUES ('6447c259-812a-4d33-afae-484bb00a5628', false, 'damir@rentr.com', true, 'Damir', 'Adamovic',  '$2a$12$aSdnp/ZQTnSDHWFuBZlybOIjhMWcY7GRNlZMHPYoQekbN3BaHM4AS', '', 'UNVERIFIED_ADMIN');
INSERT into admins(id) VALUES ('6447c259-812a-4d33-afae-484bb00a5628');
...
VALUES ('611619a9-394f-42b3-aad7-7fb123133c69', 'Regular', 0, 0.0, 0.85, 1, 1, 'orange', false);

--SILVER
INSERT INTO loyalty(id, title, available_at_points, client_discount, business_client_cut, client_points_per_reservation, business_client_points_per_reservation, color, deletable)
VALUES ('611619a9-394f-42b3-aad7-7fb123133c70', 'Silver', 10, 0.01, 0.87, 2, 2, '#999999', false);

--GOLD
INSERT INTO loyalty(id, title, available_at_points, client_discount, business_client_cut, client_points_per_reservation, business_client_points_per_reservation, color, deletable)
VALUES ('611619a9-394f-42b3-aad7-7fb123133c71', 'Gold', 40, .03, .89, 3, 3, '#FFD700', false);


-- ****** LOYALTIES TEST DATA ****** END
